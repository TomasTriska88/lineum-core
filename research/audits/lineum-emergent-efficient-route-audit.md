...
**STATUS: FROZEN**
This branch is officially frozen, exploratory only, and is not a current priority. Modality combinations including Hybrid interactions are explicitly categorized as not useful at current stage.
