...
* **C. Minimal Claim**: Spectral exhaust is confirmed to overdamp the re-ignition process. Spontaneous topological re-nucleation cannot mathematically occur, regardless of local geometric basin recapture or topological seeding, under the current `nu` thermal exhaust bounds.
